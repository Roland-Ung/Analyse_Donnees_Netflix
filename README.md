...
- **Visualisation de données (DataViz)** : Concevoir des graphiques clairs et pertinents avec Matplotlib et Seaborn, notamment la création de graphiques complexes à double axe Y (`twinx()`).
